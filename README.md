Pfforth language is a forth with python primitives. you need to se the wiki tab for a user manual.
you can run it in every deveice with python an at less 1MB of memory, better more than 5 MB.
