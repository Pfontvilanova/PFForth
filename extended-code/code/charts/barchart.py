# FORTH CODE WORD: code/charts/barchart
# Draw a vertical bar chart using plotext

WORD_NAME = 'bar-chart'
#
# === CÓDIGO FORTH ORIGINAL ===
# ( v1 v2 ... vn n -- ) Draw vertical bar chart with n values from stack
...
def execute(forth):
    if len(forth.stack) < 1:
        print("Error: bar-chart requiere n (cantidad de valores)")
        return
    n = forth.stack.pop()
