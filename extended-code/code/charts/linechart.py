# FORTH CODE WORD: code/charts/linechart
# Draw a line chart using plotext

WORD_NAME = 'line-chart'
#
# === CÓDIGO FORTH ORIGINAL ===
# ( v1 v2 ... vn n -- ) Draw line chart with n values from stack
...
def execute(forth):
    if len(forth.stack) < 1:
        print("Error: line-chart requiere n (cantidad de valores)")
        return
    n = forth.stack.pop()
